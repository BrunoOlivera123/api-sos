...
const base = [
  ...
  body("email").isEmail().withMessage("Informe um email válido").normalizeEmail(),
...
const prestadorRegister = [...base, body("telefone").optional().isString(), body("categoriaId").isInt({ min: 1 }).withMessage("Categoria inválida")];
const login = [
