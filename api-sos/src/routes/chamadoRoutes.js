...
const router = require("express").Router(),
  c = require("../controllers/chamadoController"),
  a = require("../controllers/avaliacaoController"),
  auth = require("../middlewares/authMiddleware"),
  v = require("../validations/chamadoValidation"),
  av = require("../validations/avaliacaoValidation"),
...
router.put("/:id/avaliacao", av, vm, a.update);
