...
async function main(){for(const nome of ["Eletricista","Encanador","Mecânico","Chaveiro","Guincho","Assistência Geral"]){await prisma.categoria.upsert({where:{nome},update:{},create:{nome}})}console.log("Seed concluído");}
